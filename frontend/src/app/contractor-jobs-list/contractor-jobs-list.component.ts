...
export class ContractorJobsListComponent implements OnInit {
  ...
  jobsList = [
    ...
    {Name: 'Alberta Dennis',  Location: 'Walhey, Bristol',          Date: '09-Jan-2019', Job_Type: 'PAT Testing',           Completed: true,  Quoted: true,   Latest_Quote: 200},
    ...
    {Name: 'Delia Rose',      Location: 'Clifton, Bristol',         Date: '26-Oct-2019', Job_Type: 'Broken Socket',         Completed: true,  Quoted: true,   Latest_Quote: 50},
    ...
    {Name: 'Jason Powell',    Location: 'Knowle, Bristol',          Date: '01-Jul-2019', Job_Type: 'Underfloor Heating',    Completed: true,  Quoted: true,   Latest_Quote: 2500},
