...
export class ContractorJobsListComponent implements OnInit {
   ...
   {
      Name: 'Andrew Smith',
      Location: 'Redlands, Bristol',
      Date: '14-Oct-2019',
      Job_Type: 'Rewire Property',
      Completed: false,
      Quoted: false,
      Latest_Quote: 4500
   },
   {
      Name: 'Mark Johnson',
      Location: 'Keynsham, Avon',
      Date: '09-Nov-2019',
      Job_Type: 'Underfloor Heating',
      Completed: false,
      Quoted: false,
      Latest_Quote: 2000
   },
   {
      Name: 'James Erickton',
      Location: 'Long Ahston, Bristol',
      Date: '09-Nov-2019',
      Job_Type: 'External Light',
      Completed: false,
      Quoted: true,
      Latest_Quote: 150
   },
   ...
   {
      Name: 'Casey Bryan',
      Location: 'Frampton Colterell, Avon',
      Date: '11-Nov-2019',
      Job_Type: 'Broken Socket',
      Completed: true,
      Quoted: true,
      Latest_Quote: 50
   },
   ...
   },
   {
      ...
      Date: '18-Nov-2019',
      Job_Type: 'Broken Storage Heater',
      Completed: true,
      Quoted: true,
      Latest_Quote: 250
   },
